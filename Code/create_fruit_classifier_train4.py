...
def train_model(datax, datay, valx, valy):
    ...
    print('Accuracy: mean=%.3f std=%.3f, n=%d' % (mean(history.history['accuracy'])*100, std(
        history.history['accuracy'])*100, len(history.history['accuracy'])))
...
model.save('../Models/fruits_keras_model4.h5')
print("saved")
